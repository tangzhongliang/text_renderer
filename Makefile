...
gen-chn:
	python main.py --config_file configs/default_test.yaml --output_dir /root/data/gen_images --tag chn --corpus_mode random --fonts_list data/fonts/chn --length 10 --strict --space_ratio 0 --num_img 100
